...
import { UserCheck, Plus, Download, Eye, Key, X, Trash2, AlertTriangle, ShieldAlert, AlertCircle, UserCog } from 'lucide-react';
              ...
              <div className="space-y-4">
                    ...
                    {assignedProjects.map((p, idx) => (
                      <div key={idx} className="pt-2 first:pt-0 flex items-center justify-between text-xs gap-2">
                        <div className="min-w-0">
                          ...
                          <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-sky-50 text-sky-700 border border-sky-200 inline-block mt-0.5">
                            {p.type}
                          </span>
                        </div>
                        <button
                          ...
                          className="px-2.5 py-1 text-[11px] font-semibold bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200 rounded-lg flex items-center space-x-1 transition shadow-2xs shrink-0"
                          title="Open Compliance Projects to reassign or unassign"
                        >
                ...
                <div className="p-3 bg-rose-50/80 border border-rose-200/80 rounded-xl text-xs text-rose-800 flex items-start space-x-2">
                  ...
                  <p className="leading-relaxed">
                    This assessor has assigned projects, so you cannot delete them. Please reassign or unassign their projects before deleting this account.
                  </p>
                </div>
                ...
                <div className="flex justify-between items-center pt-2">
                  <button
                    ...
                    className="px-3.5 py-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold text-xs rounded-xl shadow-xs transition flex items-center space-x-1.5"
                  >
                    <UserCog className="w-3.5 h-3.5" />
                    <span>Go to Reassign</span>
                  </button>
                  <button
                    type="button"
